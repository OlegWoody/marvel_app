const Spinner = () => {
    return (
        ...
        //     </g>
        // </svg>
        <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{margin: '35px auto', background: 'none', display: 'block'}} preserveAspectRatio="xMidYMid">
